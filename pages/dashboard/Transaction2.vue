...
<div>
    ...
    <!--Transaction Users--->
    <md-dialog :md-active.sync="openAddTransactionModal" class="modal-medium">
        <md-dialog-title class="modal-title d-block py-3 px-4 bg-light position-relative">
            ...
            <md-button @click="openAddTransactionModal = false" class="md-icon-button position-absolute">
            ...
            <form @submit.prevent="addTransaction">
                ...
                <div class="md-layout-item md-small-size-100 md-size-50">
                    <md-field slot="inputs" :class="app.getValidationClass($v.addForm,'url')">
                        ...
                        <div class="md-layout-item md-small-size-100 md-size-50">
                            <md-field slot="inputs" :class="app.getValidationClass($v.addForm,'transactional_id')">
                        ...
                        <div class="md-layout-item md-small-size-100 md-size-50">
                            <md-field slot="inputs" :class="app.getValidationClass($v.addForm,'transaction_name')">
                                <label>Transaction Name</label>
                                <md-input v-model="addForm.transaction_name"></md-input>
                                <span v-if="!$v.addForm.transaction_name.required" class="md-error">Transaction name is required</span>
                            </md-field>
                        </div>
                        <div class="md-layout-item md-small-size-100 md-size-50">
                            <md-field slot="inputs" :class="app.getValidationClass($v.addForm,'transaction_type')">
                                <label>Select Transaction Type</label>
                                <md-select id="role" v-model="addForm.transaction_type">
                                    <md-option :value="item" v-for="(item,index) in transactionsTypesList" :key="item.id">{{ index }}</md-option>
                                </md-select>
                                <span v-if="!$v.addForm.transaction_type.required" class="md-error">Transaction type is required</span>
                            </md-field>
                        </div>
                        <!-- <div class="md-layout-item md-small-size-100 md-size-50">
                        ...
                        <div class="md-layout-item md-small-size-100 md-size-50">
                            <md-field slot="inputs" :class="app.getValidationClass($v,'selectedTransactionTags')" class="tag-with-multi-input">
                                <tags-input element-id="tags" :placeholder="'Transaction Template'" v-model="selectedTransactionTags" :existing-tags="existingTags" :typeahead="true" :typeahead-style="typeaheadStyle" :allow-duplicates="allowDuplicates" :typeaheadHideDiscard="typeaheadHideDiscard" @tag-added="onTagAdded"></tags-input>
                                <!-- {{ $v.selectedTransactionTags }} -->
                                <!-- <span v-if="!$v.selectedTags.required" class="md-error">Tag is required</span> -->
                            </md-field>
                        </div>
                    </div>
                </md-content>
                <md-dialog-actions class="flex-wrap justify-content-center">
                    <md-button type="submit" class="md-primary w-100 button-primary-custom mb-3 mt-3">
                        <LoadingButtonLoader :typeEnable="'simpleLoader'" v-bind:enable="app.loading" class="mr-1" />Next
                    </md-button>
    ...
    <md-dialog :md-active.sync="openTransactionDetails">
        <md-dialog-title class="modal-title d-block py-3 px-4 bg-light position-relative">
                ...
                <md-content md-dynamic-height class="px-0">
                    <div class="md-layout">
                        <div class="md-layout-item md-medium-size-100 md-size-100 md-small-size-100">
                            <div class="md-layout">
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs" :class="app.getValidationClass($v.transactionalForm,'sales_price')" class="multi-error">
                                        <label>Sales price</label>
                                        <span class="md-prefix">$</span>
                                        <md-input v-model="transactionalForm.sales_price"></md-input>
                                        <span v-if="!$v.transactionalForm.sales_price.required" class="md-error">Sales price is required</span>
                                        <span v-if="!$v.transactionalForm.sales_price.priceValid.isfloat" class="md-error">Please enter decimal or number</span>
                                    </md-field>
                                </div>
                                <div class="md-layout-item md-small-size-100 md-size-50">
                      ...
                      >Firstname is required</span>-->
                                ...
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs" :class="app.getValidationClass($v.transactionalForm,'street_no')">
                                        <label>Street No</label>
                                        <md-input v-model="transactionalForm.street_no"></md-input>
                                        <span v-if="!$v.transactionalForm.street_no.required" class="md-error">Street no is required</span>
                                    </md-field>
                                </div>
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs" :class="app.getValidationClass($v.transactionalForm,'street_address')">
                                        <label>Street Address</label>
                                        <md-input v-model="transactionalForm.street_address"></md-input>
                                        <span v-if="!$v.transactionalForm.street_address.required" class="md-error">Street address is required</span>
                                    </md-field>
                                </div>
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs" :class="app.getValidationClass($v.transactionalForm,'state')">
                                        <label>Select State</label>
                                        <md-select id="role" v-model="transactionalForm.state" @md-selected="stateSelect">
                                            <md-option :value="item.id" v-for="(item) in stateLists" :key="item.id">{{ item.state_name }}</md-option>
                                        </md-select>
                                        <span v-if="!$v.transactionalForm.state.required" class="md-error">State is required</span>
                                    </md-field>
                                </div>
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs" class="multi-error" :class="app.getValidationClass($v.transactionalForm,'city')">
                                        <label>Select city</label>
                                        <md-select id="addForm-city" v-model="transactionalForm.city" @md-selected="citySelect">
                                            <md-option :value="0">Choose city</md-option>
                                            <md-option :value="JSON.stringify({ id: item.id, id_state: item.id_state })" v-for="(item) in citiesLists" :key="item.id">{{ item.city }}</md-option>
                                        </md-select>
                                        <span v-if="!$v.transactionalForm.city.required" class="md-error">City is required</span>
                                        <span v-if="!$v.transactionalForm.city.isStateSelect" class="md-error">Please select state first</span>
                                    </md-field>
                                </div>
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs">
                                        <label>Zip code</label>
                                        <md-input v-model="addForm.zip_code"></md-input>
                                        <!-- <span
                      ...
                      >Lastname is required</span>-->
                                ...
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs" class="multi-error datepicker-md-field" :class="app.getValidationClass($v.transactionalForm,'executed_date')">
                                        <md-datepicker v-model="transactionalForm.executed_date" @md-closed="changeDate" :md-disabled-dates="executedDisabledDates" class="date-picker-custom">
                                            <label>Executed Date</label>
                                        </md-datepicker>
                                        <span v-if="!$v.transactionalForm.executed_date.required" class="md-error">Executed Date is required</span>
                                    </md-field>
                                </div>
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs" class="multi-error datepicker-md-field" :class="app.getValidationClass($v.transactionalForm,'closed_date')">
                                        <!-- <md-input v-model="addForm.closed_date"></md-input> -->
                                        <md-datepicker v-model="transactionalForm.closed_date" :md-disabled-dates="closedDisabledDates" class="date-picker-custom" @md-opened="closedDateChange">
                                            <label>Closed Date</label>
                                        </md-datepicker>
                                        <span v-if="!$v.transactionalForm.closed_date.required" class="md-error">Closed Date is required</span>
                                        <span v-if="!$v.transactionalForm.closed_date.isExecutedDateSelect" class="md-error">Select executed date first</span>
                                    </md-field>
                                </div>
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs">
                                ...
                                <div class="md-layout-item md-small-size-100 md-size-50">
                                    <md-field slot="inputs" :class="app.getValidationClass($v.transactionalForm,'additional_fees')">
                                        <label>Additional fees</label>
                                        <md-input v-model="transactionalForm.additional_fees"></md-input>
                                        <span v-if="!$v.transactionalForm.additional_fees.feesValid.isfloat" class="md-error">Please enter decimal or number</span>
                                    </md-field>
                                </div>
                            </div>
                            <md-dialog-actions class="flex-wrap px-0">
                                <div class="d-flex w-100 align-center justify-content-between nav-button-modal">
                                    <div class="d-block text-center">
                                        <md-button type="submit" class="cancel-link lighter-description mb-3 mt-3">
                        ...
                        <md-option value="3">Agent</md-option>
                            ...
                            <md-dialog-actions class="flex-wrap justify-content-start px-0">
                                <md-button type="submit" class="md-primary button-primary-custom mb-3 mt-3 px-4">
                                    <LoadingButtonLoader :typeEnable="app.checkType('simpleLoader')" v-bind:enable="app.loading" class="mr-1" />
                                </md-button>
    ...
    <md-dialog :md-active.sync="openCompleteStep" class="modal-medium">
        ...
        <div class="md-dialog-content p-0">
            <md-content md-dynamic-height class="px-4">
                <div class="md-layout">
                    <div class="md-layout-item md-small-size-100 md-size-100">Your transactional is added successfully.</div>
                    <md-dialog-actions class="flex-wrap justify-content-center">
                        <md-button type="submit" @click="updateCompleteStep" class="md-primary w-100 button-primary-custom mb-2 mt-3">
                            <LoadingButtonLoader :typeEnable="'simpleLoader'" v-bind:enable="app.loading" class="mr-1" />Done
                        </md-button>
                    </md-dialog-actions>
                </div>
            </md-content>
                    ...
                    <div class="md-layout">
                        <div class="md-layout-item md-small-size-100 md-size-100">
                            <md-field slot="inputs" :class="app.getValidationClass($v.editForm,'description')">
                                ...
                                <span v-if="!$v.editForm.description.required" class="md-error">Description is required</span>
                            </md-field>
                        </div>
                        <div class="md-layout-item md-small-size-100 md-size-50">
    ...
    <div class="md-layout flex-md-column-reverse">
            ...
            <md-card class="md-card-plain md-card-custom custom-shadow radius-10 mt-0">
                <md-card-header class="px-4 mb-0 mt-0">
                    <div class="md-headline d-flex align-center justify-content-between">
                        ...
                        <md-button class="md-primary button-custom-regular heading-add-button px-2" @click="openAddTransactionFunction">
                ...
                <md-card-content class="px-4 py-3 position-relative table-loader">
                    <LoadingButtonLoader :typeEnable="'pageLoader'" v-bind:enable="app.loading" class="mr-1 table-loader position-absolute d-flex align-center justify-content-center w-100" />
                ...
                <md-table-cell>{{ transaction.last_name }}</md-table-cell>-->
                            ...
                            <md-table-cell v-else-if="transaction.status == 2">
                                <label for class="mr-3 closed-label description d-flex align-center justify-content-center">{{ 'Closed' }}</label>
                            </md-table-cell>
                            <md-table-cell v-else-if="transaction.status == 3">
                                <label for class="mr-3 closed-label description d-flex align-center justify-content-center">{{ 'Canceled' }}</label>
                            </md-table-cell>
                            <md-table-cell v-else>Not Active</md-table-cell>
                            <md-table-cell v-if="transaction.transaction_type == 1">
                                <label for class="mr-3 active-label description d-flex align-center justify-content-center">{{ 'Buyer' }}</label>
                            </md-table-cell>
                            <md-table-cell v-else-if="transaction.transaction_type == 2">
                                <label for class="mr-3 closed-label description d-flex align-center justify-content-center">{{ 'Seller' }}</label>
                            </md-table-cell>
                ...
                >{{ tag }}</md-table-cell>-->
                            ...
                            <md-table-cell>
                                <md-list class="agents-ul">
                                    <md-list-item v-for="(index, item ) in calculateImageDetail(transaction.users,transaction.images)" v-bind:key="item">
                    ...
                    <div class="md-layout" v-if="totalTransactions > 10">
                        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50 d-flex align-center">
                            <p class="description font-weight-medium" v-if="totalTransactions">Displaying {{ currentCount }} of {{ totalTransactions }} records</p>
                        </div>
                        <div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-50">
                            <!-- for pagination you can check vue material kit -->
                            <ul class="pagination">
                                <li class="page-item prev-page" v-if="page != 1" v-bind:class="[changePage == pageNumber ? 'active' : '']">
                                    <a @click="page--" class="page-link" aria-label="Previous">
                                        <i class="fas fa-angle-double-left"></i>
                                        <span v-if="withText" class="pr-1">Prev</span>
                                    </a>
                                </li>
                                <li class="page-item" v-for="pageNumber in pages.slice(page-1, page+5)" v-bind:key="pageNumber" v-bind:class="[changePage == pageNumber ? 'active' : '']">
                                    <a @click="page = pageNumber" class="page-link">{{ pageNumber }}</a>
                                </li>

                                <li class="page-item page-pre next-page" v-if="page < pages.length" v-bind:class="[changePage == pageNumber ? 'active' : '']">
        ...
        <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-25">
            <div class="search-right mb-4">
                <md-field class="custom-shadow bg-white search-outer p-3 radius-10 position-relative" md-inline>
              ...
              <router-link to="/transactions">-->
                    ...
                    <div class="filter-section" v-if="isToggled">
                        <div>
                            ...
                            <div class="d-flex justify-content-between align-center">
                                <v-md-date-range-picker :opens="'right'" :presets="presets" @change="dateFilterChange"></v-md-date-range-picker>
                        ...
                        <div>
                            ...
                            <div class="d-flex justify-content-between align-center">
                                <md-checkbox v-model="status_filter" :value="1" @change="handleChangeFilter($event)" class>Active</md-checkbox>
                                <label for class="label-account" v-if="countArray[0]">{{ countArray[0].activeCount}}</label>
                            </div>
                            <div class="d-flex justify-content-between align-center">
                                <md-checkbox v-model="status_filter" :value="2" @change="handleChangeFilter($event)" class>Closed</md-checkbox>
                                <label for class="label-account" v-if="countArray[0]">{{ countArray[0].closedCount}}</label>
                            </div>
                            <div class="d-flex justify-content-between align-center">
                                <md-checkbox v-model="status_filter" :value="3" @change="handleChangeFilter($event)" class>Canceled</md-checkbox>
                                <label for class="label-account" v-if="countArray[0]">{{ countArray[0].canceledCount}}</label>
                            </div>
                ...
                <label for="mike">Mike</label>-->
                        ...
                        <div>
                            ...
                            <div class="d-flex justify-content-between align-center">
                                <md-checkbox v-model="type_filter" :value="1" @change="handleChangeFilter($event)" class>Buyer</md-checkbox>
                                <label for class="label-account" v-if="countArray[0]">{{ countArray[0].buyerCount}}</label>
                            </div>
                            <div class="d-flex justify-content-between align-center">
                                <md-checkbox v-model="type_filter" :value="2" @change="handleChangeFilter($event)" class>Seller</md-checkbox>
                                <label for class="label-account" v-if="countArray[0]">{{ countArray[0].sellerCount}}</label>
                            </div>
                            <hr />
                        </div>
                        ...
                        <div>
                            ...
                            <div class="d-flex justify-content-between align-center">
                                <md-checkbox v-model="role_filter" :value="2" @change="handleChangeFilter($event)" class>Agent</md-checkbox>
                                <label for class="label-account" v-if="countArray[0]">{{ countArray[0].agentCount }}</label>
                            </div>
                            <div class="d-flex justify-content-between align-center">
                                <md-checkbox v-model="role_filter" :value="3" @change="handleChangeFilter($event)" class>Co-ordinator</md-checkbox>
                                <label for class="label-account" v-if="countArray[0]">{{ countArray[0].coordinatorCount }}</label>
                            </div>
                            <!-- <div class="d-flex justify-content-between align-center">
                                <md-checkbox
                                    v-model="role_filter"
    ...
    <AddTransactionUserModal :active="openAddTransactionUserModal" :app="app" :transaction_id="passTransactionId()" @dialogClose="handleDialogClose" @dialogOpen="handleDialogOpen" ref="addTransactionUserModal" />

    <TransactionStepsModal :active="openAddTransactionSteps" :app="app" :transaction_id="passTransactionId()" @dialogClose="handleDialogClose" @dialogOpen="handleDialogOpen" ref="transactionStepsModal" :templates="existingTags" />
    <AddNewStepModal :active="openAddNewStepModal" :app="app" :transaction_id="passTransactionId()" @dialogClose="handleDialogClose" @dialogOpen="handleDialogOpen" ref="addNewStepModal" />

    <AddUserModel :active="openAddNewUser" :app="app" :userModelTitle="'Add New User'" :propObj1="false" :propObj2="''" :transaction_id="passTransactionId()" @dialogClose="handleDialogClose" @dialogOpen="handleDialogOpen" ref="addUserModel" />
</div>
</template>
...
export default {
    ...
    data: function () {
        ...
        return {
            ...
            dateRange1: "",
            dateRange2: "",
            /*transaction detail close date */
            closedDateFocus: false,
            cityDisabledFocus: true
        };
    },
    validations: {
        addForm: {
    ...
    methods: {
        ...
        addTransactionalDetails() {
            ...
            const data = {
                transactionAutoIncrementId: this.transactionAutoIncrementId ?
                    this.transactionAutoIncrementId : null,
                ...
                city: this.transactionalForm.city ?
                    JSON.parse(this.transactionalForm.city).id : null,
                ...
                strto_executed_date: this.transactionalForm.executed_date ?
                    Number(new Date(this.transactionalForm.executed_date)) : null,
                closed_date: this.transactionalForm.closed_date,
                strto_closed_date: this.transactionalForm.closed_date ?
                    Number(new Date(this.transactionalForm.closed_date)) : null,
        ...
        updateTransactionDetails() {
            ...
            const data = {
                ...
                executed_date: this.editForm.executed_date ?
                    Number(this.editForm.executed_date) : null,
        ...
        citySelect(value) {
            // let city = this.$v.transactionalForm.city;
        ...
        stateSelect(value) {
            this.cityDisabledFocus = false;

            // debugger;
            // this.$v.transactionalForm.city.$error = true;
        ...
        changeDate(event) {
            // let date = this.addForm.executed_date;
        ...
        dateFilterChange(values) {
            ...
            this.dateRange1 = date1.getFullYear() + "-" + date1.getMonth() + "-" + date1.getDate();
            this.dateRange2 = date2.getFullYear() + "-" + date2.getMonth() + "-" + date2.getDate();
