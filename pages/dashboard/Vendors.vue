<template>
  <div class="users">
            ...
            <div class="md-layout">
              <div class="md-layout-item md-medium-size-100 md-size-100 md-small-size-100">
                <p class="text-primary description text-center mt-4 mb-3">
                  ...
                  <span class="brand-primary">{{this.userSelectedName}}</span> from the team.
                </p>
    ...
    <!-- COMMENT S@Softo //2 MARCH 2020 HERE WE WILL USE SAME REUSE VENDOR COMPONENT MODEL -->
    <md-dialog :md-active.sync="showDialog">
      <md-dialog-title class="modal-title d-block py-3 px-4 bg-light">
        <h4 class="my-0 md-headline text-left text-primary">{{this.headingTitle}}</h4>
      </md-dialog-title>
          ...
          <md-card-header class="px-4 mb-0 mt-0">
            <div class="md-headline">
              ...
              <span class="brand-primary">
                <md-icon>keyboard_arrow_right</md-icon>Vendor
              </span>
            </div>
          </md-card-header>
          <md-card-content class="px-4 py-3">
            <div class="md-layout">
              <div class="md-layout-item d-flex justify-content-between mb-3">
                <h3 class="md-title text-primary">Team vendors</h3>
              ...
              <md-table-row v-for="user in users" v-bind:key="user.id">
                <md-table-cell md-label="Name" class="avatar-cell">
                  ...
                  <div v-if="user.image" class="md-avatar position-absolute">
                    <img v-bind:src="'/images/users/' + user.image" alt="Agent" />
                  </div>
        ...
        <div class="search-right mb-4">
          ...
          <div class="mx-auto filter-section-outer md-hide">
            <div class="d-flex justify-content-between align-center mb-3 filter-heading-section">
              ...
              <small class="lighter-description font-weight-medium">Reset filter as</small>
            </div>
...
export default {
  ...
  methods: {
    ...
    addUsers() {
      this.headingTitle = "Add new vendor";
    ...
    onImageLoadFailure(event) {
      isShow = true;
      // event.target.src = "https://placeimg.com/40/40/people/1";
